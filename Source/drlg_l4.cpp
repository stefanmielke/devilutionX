...
{
	{
		auto lpSetPiece = LoadFileInMem<uint16_t>("Levels\\L4Data\\diab1.DUN");
		diabquad1x = 4 + l4holdx;
		diabquad1y = 4 + l4holdy;
		DRLG_L4SetRoom(lpSetPiece.get(), diabquad1x, diabquad1y);
	}
	{
		auto lpSetPiece = LoadFileInMem<uint16_t>(preflag ? "Levels\\L4Data\\diab2b.DUN" : "Levels\\L4Data\\diab2a.DUN");
		diabquad2x = 27 - l4holdx;
		diabquad2y = 1 + l4holdy;
		DRLG_L4SetRoom(lpSetPiece.get(), diabquad2x, diabquad2y);
	}
	{
		auto lpSetPiece = LoadFileInMem<uint16_t>(preflag ? "Levels\\L4Data\\diab3b.DUN" : "Levels\\L4Data\\diab3a.DUN");
		diabquad3x = 1 + l4holdx;
		diabquad3y = 27 - l4holdy;
		DRLG_L4SetRoom(lpSetPiece.get(), diabquad3x, diabquad3y);
	}
	{
		auto lpSetPiece = LoadFileInMem<uint16_t>(preflag ? "Levels\\L4Data\\diab4b.DUN" : "Levels\\L4Data\\diab4a.DUN");
